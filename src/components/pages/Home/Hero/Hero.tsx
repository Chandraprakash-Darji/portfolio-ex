...
const Hero: FC = () => {
  ...
  return (
    <section
      id="hero"
      className="relative mx-auto flex select-none flex-col mt-32 pt-8 pb-20 sm:text-xl md:flex-row md:justify-between md:pt-20 lg:gap-10 xl:pt-24 xl:pb-32 2xl:pt-28"
    >
