        ...
        >
            <div className="flex flex-col gap-3 md:gap-5 lg:gap-10 px-3">
                <p className="md:text-xl lg:text-2xl xl:text-3xl text-primary before:content-['<p>_'] before:text-mainDark after:content-['_</p>'] after:text-mainDark ">
                    <AnimatedText text="I am" speed={50} delay={1} />
                </p>
                <h1
                    className="text-2xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-[6rem] py-10 pl-10 lg:pl-20 relative before:content-['<h1>'] before:text-mainDark after:content-['</h1>'] after:text-mainDark before:text-base lg:before:text-3xl after:text-base lg:after:text-3xl before:absolute before:left-5 lg:before:left-10 before:top-3 lg:before:top-0 after:absolute after:bottom-3 lg:after:bottom-0  after:left-5 lg:after:left-10 leading-[1.1] after:font-sans after:not-italic after:font-normal before:not-italic before:font-normal before:font-sans magic-vanishIn font-bold italic"
                    style={{
                        fontFamily:
                            "'Hack', ui-sans-serif, system-ui, -apple-system, Roboto, Arial, sans-serif",
                    }}
                >
                    Chandra <br /> Prakash Darji
                </h1>
                <p className="md:text-xl lg:text-2xl xl:text-3xl text-primary before:content-['<p>'] before:text-mainDark after:content-['</p>'] after:text-mainDark ">
                    {" "}
                    Frontend Developer // UI Designer{" "}
                </p>
            </div>
            <a href="#resume" className="magic-vanishIn">
